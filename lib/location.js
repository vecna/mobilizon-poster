...
async function queryLocation(locationString, localeString, api) {
    ...
    debug(`Fetched ${responseBody.data.searchAddress.length} possible locations, the first is:`);
    debug(responseBody.data.searchAddress[0]);

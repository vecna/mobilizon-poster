...
async function postToMobilizon(eventvars) {
   ...
   /* console.log(eventvars.location)
    ...
    createEvent.variables.organizerActorId = eventvars.organizer_id;
    createEvent.variables.attributedToId = eventvars.attributed_to_id;
    createEvent.variables.tags = eventvars.tags ? eventvars.tags : ['unofficial'];
    debug(createEvent.variables);
